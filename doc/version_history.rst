...
- Support the ts-conda-build 0.5 in conda recipe. (`OSW-1202 <https://rubinobs.atlassian.net//browse/OSW-1202>`_)
...
- Add the timeout argument when commanding the power, closed-loop control mode, and ILC mode. (`OSW-895 <https://rubinobs.atlassian.net//browse/OSW-895>`_)
