...
class TestMockDeadbandControl(unittest.TestCase):
    ...
    def test_select_disabled(self) -> None:
        ...
        hardpoint_error_selected = self.deadband_control.select(hardpoint_error, is_enabled=False)
    ...
    def test_select_enabled(self) -> None:
        ...
        hardpoint_error_selected_1 = self.deadband_control.select(hardpoint_error_1, is_enabled=True)
        ...
        hardpoint_error_selected_2 = self.deadband_control.select(hardpoint_error_2, is_enabled=True)
        ...
        hardpoint_error_selected_3 = self.deadband_control.select(hardpoint_error_3, is_enabled=True)
        ...
        hardpoint_error_selected_4 = self.deadband_control.select(hardpoint_error_4, is_enabled=True)
        ...
        hardpoint_error_selected_5 = self.deadband_control.select(hardpoint_error_5, is_enabled=True)
        ...
        hardpoint_error_selected_6 = self.deadband_control.select(hardpoint_error_6, is_enabled=True)
    ...
    def test_select_zero_threshold(self) -> None:
        ...
        # Disabled
        hardpoint_error_1 = np.array([0.1, 0.2, 0.0])
        hardpoint_error_selected_1 = deadband_control.select(hardpoint_error_1, is_enabled=False)
        ...
        hardpoint_error_selected_2 = deadband_control.select(hardpoint_error_2, is_enabled=True)
    ...
    def test_reset(self) -> None:
        ...
        self.assertFalse(self.deadband_control._keep_tracking)
        np.testing.assert_equal(self.deadband_control._hardpoint_error_track, hardpoint_error)

        # Reset all
        self.deadband_control.reset(reset_all=True)

        np.testing.assert_equal(self.deadband_control._hardpoint_error_track, np.zeros(3))
